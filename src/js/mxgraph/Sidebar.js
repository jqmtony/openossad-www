...
{
	this.addPalette('general', mxResources.get('general'), expand || false, mxUtils.bind(this, function(content)
	{
...
Sidebar.prototype.addProcedurePalette = function(expand)
{
...
Sidebar.prototype.addTasksPalette = function(expand)
{
